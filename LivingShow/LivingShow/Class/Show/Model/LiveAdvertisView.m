...
#import "LiveAdvertisView.h"
#import "UIImageView+WebCache.h"

@interface LiveAdvertisView ()
...
@implementation LiveAdvertisView



+ (instancetype)loadAdvertiseView {
    
    return [[[NSBundle mainBundle] loadNibNamed:@"LiveAdvertisView" owner:self options:nil] lastObject];
}
...
//    }
    ...
    [LiveLiveHandler executeGetAdvertiseWithSuccess:^(id obj) {
...
//            
//            NSString * str = [NSString stringWithFormat:@"%@%@",IMAGE_HOST,];
//            
//            UIImage * image = [[UIImage alloc]initWithData:[NSData dataWithContentsOfURL:imageUrl]];
//            
//            self.imageView.image = image;
            
            [self.imageView downloadImage:ad.image placeholder:@"psb"];
